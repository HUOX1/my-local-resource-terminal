...
QPushButton#movieEpisodeButton {{
    min-height: 32px;
    padding: 0 13px;
    background: {t.SURFACE_RAISED};
    border: 1px solid {t.BORDER};
...
QPushButton#movieEpisodeButton:hover {{
    background: {t.SURFACE_HOVER};
    border-color: {t.BORDER_STRONG};
}}
QPushButton#movieEpisodeButton:disabled {{
    color: {t.TEXT_MUTED};
    background: transparent;
    border-color: {t.CHROME_BORDER};
}}
QPushButton#movieEpisodeInfoButton {{
    padding: 0;
    background: transparent;
    border: 1px solid transparent;
    border-radius: {t.RADIUS_SMALL}px;
}}
QPushButton#movieEpisodeInfoButton:hover {{
    background: {t.SURFACE_HOVER};
    border-color: {t.BORDER};
}}
QDialog#movieEpisodeDialog, QWidget#movieEpisodeDialogContent {{
    background: {t.WINDOW_BG};
}}
QLabel#movieEpisodeDialogTitle {{
    color: {t.TEXT_PRIMARY};
    font-size: 19px;
    font-weight: 700;
}}
QFrame#movieEpisodeDetailCard {{
    background: {t.SURFACE};
    border: 1px solid {t.CHROME_BORDER};
    border-radius: {t.RADIUS_MEDIUM}px;
}}
QLabel#movieEpisodeDetailHeading {{
    color: {t.TEXT_PRIMARY};
    font-weight: 700;
}}
QLabel#movieEpisodeDetailText {{
    color: {t.TEXT_SECONDARY};
}}
QScrollArea#movieEpisodeDialogScroll {{
    background: transparent;
    border: 0;
}}
