...
logger = logging.getLogger("g3.websocket")
        ...
        try:
            async for raw in websocket:
                ...
                try:
                    ...
                    logger.warning(
                        "Bad backend request: type=%s id=%s error=%s",
                        request_type,
                        request_id,
                        exc,
                    )
                    ...
                    logger.error(
                        "Backend command failed: type=%s id=%s payload=%r error=%s",
                        request_type,
                        request_id,
                        request_payload,
                        exc,
                    ...
                    logger.exception(
                        "Backend command failed: type=%s id=%s payload=%r",
                        request_type,
                        request_id,
                        request_payload,
                    )
